...
whether the bitwise *and* of its operands is different from zero."}}
                  ...
                  :extract {:binding "bit32.extract"
                            :metadata {:fnl/arglist ["n" "field" "?width"]
...
```"}}
                  :replace {:binding "bit32.replace"
                            :metadata {:fnl/arglist ["n" "v" "field" "?width"]
...
This shift operation is what is called logical shift."}}}
         :metadata {:fnl/docstring "This library provides bitwise operations.
...
up to the first integer key absent from the table."}}
 :load {:binding "load"
        :metadata {:fnl/arglist ["ld" "?source" "?mode" "?env"]
