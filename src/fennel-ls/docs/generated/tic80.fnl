...
"}}
 :BOOT {:binding "BOOT"
        :metadata {:fls/itemKind "Function"
                   :fnl/docstring "Startup function.
"}}
 :MENU {:binding "MENU"
        :metadata {:fls/itemKind "Function"
                   :fnl/arglist ["index"]
...
"}}
 :fset {:binding "fset"
        :metadata {:fls/itemKind "Function"
                   :fnl/arglist ["sprite_id" "flag" "bool"]
...
"}}
 :tri {:binding "tri"
       :metadata {:fls/itemKind "Function"
                  :fnl/arglist ["x1" "y1" "x2" "y2" "x3" "y3" "color"]
