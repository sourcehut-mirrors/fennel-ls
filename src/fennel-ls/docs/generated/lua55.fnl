...
;; Lua 5.5 Reference Manual last updated Mon Dec 15 21:02:05 UTC 2025
(local docs {:_G
 {:binding
  "_G"
  :metadata
...
(That is, `dofile` does not run in protected mode.)"}}
 ...
 {:binding
  ...
  {:fls/itemKind
   ...
   ["message" "?level"]
   :fnl/docstring
   "Raises an errorwith `message` as the error object.
...
(if `?mode` is `\"w\"`)."}}
   ...
   :stderr
   {:binding "io.stderr"
    :metadata {:fls/itemKind "Variable" :fnl/docstring "stderr file"}}
   :stdin
   {:binding "io.stdin"
    :metadata {:fls/itemKind "Variable" :fnl/docstring "stdin file"}}
   :stdout
   {:binding "io.stdout"
    :metadata {:fls/itemKind "Variable" :fnl/docstring "stdout file"}}
   :tmpfile
   {:binding
    "io.tmpfile"
    :metadata
...
that rounds the quotient towards zero. (integer/float)"}}
   ...
   {:binding
    ...
    {:fls/itemKind
     ...
     ["x"]
     :fnl/docstring
     "Returns two numbers `m` and `e` such that *x = m2ᵉ*,
...
a value greater than any other numeric value."}}
   ...
   {:binding
    ...
    {:fls/itemKind "Function"
     :fnl/arglist ["m" "e"]
     :fnl/docstring "Returns *m2ᵉ*, where `e` is an integer."}}
   :log
   {:binding
    "math.log"
    :metadata
...
Its second result is always a float."}}
   :pi
   {:binding "math.pi"
    :metadata {:fls/itemKind "Variable" :fnl/docstring "The value of *π*."}}
   :rad
   {:binding
    "math.rad"
    :metadata
