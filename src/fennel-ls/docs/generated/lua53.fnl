...
* The fifth line is a mark to ignore all text after it
  ...
  Default is `\"-\"`."}}
                    :cpath {:binding "package.cpath"
                            :metadata {:fls/itemKind "Variable"
                                       :fnl/docstring "The path used by `require` to search for a C loader.
...
plus other Unix systems that support the `dlfcn` standard)."}}
                    :path {:binding "package.path"
                           :metadata {:fls/itemKind "Variable"
                                      :fnl/docstring "The path used by `require` to search for a Lua loader.
...
table used by `require`."}}
                    :searchers {:binding "package.searchers"
                                :metadata {:fls/itemKind "Variable"
                                           :fnl/docstring "A table used by `require` to control how to load modules.
...
and returns a string with the concatenation of all these sequences."}}
                 :charpattern {:binding "utf8.charpattern"
                               :metadata {:fls/itemKind "Variable"
                                          :fnl/docstring "The pattern (a string, not a function) `\"[\\0-\\x7F\\xC2-\\xF4][\\x80-\\xBF]*\"`
