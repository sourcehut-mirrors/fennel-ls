;; auto-generated by `make docs` from fennel-ls. Contents come from https://www.lua.org/manual/5.2/manual.html
...
The current contents of this variable is `\"Lua 5.2\"`."}}
 :arg {:binding "arg"
       :metadata {:fls/itemKind "Variable"
                  :fnl/docstring "Before starting to run the script,
...
when absent, it defaults to \"assertion failed!\""}}
 :bit32 {:binding "bit32"
         :fields {:arshift {:binding "bit32.arshift"
                            :metadata {:fls/itemKind "Function"
                                       :fnl/arglist ["x" "disp"]
                                       :fnl/docstring "Returns the number `x` shifted `disp` bits to the right.
...
result in zero or `0xFFFFFFFF` (all original bits are shifted out)."}}
                  :band {:binding "bit32.band"
                         :metadata {:fls/itemKind "Function"
                                    :fnl/arglist ["..."]
                                    :fnl/docstring "Returns the bitwise *and* of its operands."}}
                  :bnot {:binding "bit32.bnot"
                         :metadata {:fls/itemKind "Function"
                                    :fnl/arglist ["x"]
                                    :fnl/docstring "Returns the bitwise negation of `x`.
For any integer `x`,
...
The default for `?width` is 1."}}
                  :lrotate {:binding "bit32.lrotate"
                            :metadata {:fls/itemKind "Function"
                                       :fnl/arglist ["x" "disp"]
                                       :fnl/docstring "Returns the number `x` rotated `disp` bits to the left.
The number `disp` may be any representable integer.
...
negative displacements rotate to the right."}}
                  :lshift {:binding "bit32.lshift"
                           :metadata {:fls/itemKind "Function"
                                      :fnl/arglist ["x" "disp"]
                                      :fnl/docstring "Returns the number `x` shifted `disp` bits to the left.
The number `disp` may be any representable integer.
...
```"}}
                  :replace {:binding "bit32.replace"
                            :metadata {:fls/itemKind "Function"
                                       :fnl/arglist ["n" "v" "field" "?width"]
                                       :fnl/docstring "Returns a copy of `n` with
the bits `field` to `field + width - 1`
replaced by the value `v`.
See `bit32.extract` for details about `field` and `?width`."}}
                  :rrotate {:binding "bit32.rrotate"
                            :metadata {:fls/itemKind "Function"
                                       :fnl/arglist ["x" "disp"]
                                       :fnl/docstring "Returns the number `x` rotated `disp` bits to the right.
The number `disp` may be any representable integer.
...
This shift operation is what is called logical shift."}}}
         :metadata {:fls/itemKind "Module"
                    :fnl/docstring "This library provides bitwise operations.
...
the remainder of its division by *2³²*
and truncated to an integer (in some unspecified way),
so that its final value falls in the range *[0,2³² - 1]*.
Similarly, all results are in the range *[0,2³² - 1]*.
...
Any arguments to `yield` are passed as extra results to `resume`."}}}
             :metadata {:fls/itemKind "Module"
                        :fnl/docstring "The operations related to coroutines comprise a sub-library of
...
(default is 1, the function calling `traceback`)."}}
                  :upvalueid {:binding "debug.upvalueid"
                              :metadata {:fls/itemKind "Function"
                                         :fnl/arglist ["f" "n"]
                                         :fnl/docstring "Returns an unique identifier (as a light userdata)
...
because they rely on the global C variable `errno`."}}
 :ipairs {:binding "ipairs"
          :metadata {:fls/itemKind "Function"
                     :fnl/arglist ["t"]
                     :fnl/docstring "If `t` has a metamethod `__ipairs`,
...
(or zero when `x` is zero)."}}
                 :huge {:binding "math.huge"
                        :metadata {:fls/itemKind "Variable"
                                   :fnl/docstring "The value `HUGE_VAL`,
...
(You can also use the expression `x^0.5` to compute this value.)"}}
        ...
        :metadata {:fls/itemKind "Module"
                   :fnl/docstring "This library is an interface to the standard C math library.
...
of list `t`."}}
                  :pack {:binding "table.pack"
                         :metadata {:fls/itemKind "Function"
                                    :fnl/arglist ["..."]
                                    :fnl/docstring "Returns a new table with all parameters stored into keys 1, 2, etc.
