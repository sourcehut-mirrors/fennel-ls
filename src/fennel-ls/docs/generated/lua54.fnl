...
The current value of this variable is `\"Lua 5.4\"`."}}
 :arg {:binding "arg"
       :metadata {:fls/itemKind "Variable"
                  :fnl/docstring "Before running any code,
...
Any arguments to `yield` are passed as extra results to `resume`."}}}
             :metadata {:fls/itemKind "Module"
                        :fnl/docstring "This library comprises the operations to manipulate coroutines,
...
refer to the `n2`-th upvalue of the Lua closure `f2`."}}}
         :metadata {:fls/itemKind "Module"
                    :fnl/docstring "This library provides
...
(if `?mode` is `\"w\"`)."}}
               ...
               :stderr {:binding "io.stderr"
                        :metadata {:fls/itemKind "Variable"
                                   :fnl/docstring "stderr file"}}
               :stdin {:binding "io.stdin"
                       :metadata {:fls/itemKind "Variable"
                                  :fnl/docstring "stdin file"}}
               :stdout {:binding "io.stdout"
                        :metadata {:fls/itemKind "Variable"
                                   :fnl/docstring "stdout file"}}
...
or **fail** if `obj` is not a file handle."}}
      ...
      :metadata {:fls/itemKind "Module"
                 :fnl/docstring "The I/O library provides two different styles for file manipulation.
...
that rounds the quotient towards zero. (integer/float)"}}
                 :huge {:binding "math.huge"
                        :metadata {:fls/itemKind "Variable"
                                   :fnl/docstring "The float value `HUGE_VAL`,
...
according to the Lua operator `<`."}}
                 :maxinteger {:binding "math.maxinteger"
                              :metadata {:fls/itemKind "Variable"
                                         :fnl/docstring "An integer with the maximum value for an integer."}}
...
according to the Lua operator `<`."}}
                 :mininteger {:binding "math.mininteger"
                              :metadata {:fls/itemKind "Variable"
                                         :fnl/docstring "An integer with the minimum value for an integer."}}
...
they are compared as unsigned integers."}}}
        :metadata {:fls/itemKind "Module"
                   :fnl/docstring "This library provides basic mathematical functions.
...
which automatically removes the file when the program ends."}}}
      :metadata {:fls/itemKind "Module"
                 :fnl/docstring "This library is implemented through table `os`."}}
 :package {:binding "package"
           :fields {:config {:binding "package.config"
                             :metadata {:fls/itemKind "Variable"
                                        :fnl/docstring "A string describing some compile-time configurations for packages.
...
* The fifth line is a mark to ignore all text after it
  ...
  Default is `\"-\"`."}}
                    :cpath {:binding "package.cpath"
                            :metadata {:fls/itemKind "Variable"
                                       :fnl/docstring "A string with the path used by `require`
...
or a default path defined in `luaconf.h`."}}
                    :loaded {:binding "package.loaded"
                             :metadata {:fls/itemKind "Variable"
                                        :fnl/docstring "A table used by `require` to control which
...
is replaced by the default path."}}
                    :preload {:binding "package.preload"
                              :metadata {:fls/itemKind "Variable"
                                         :fnl/docstring "A table to store loaders for specific modules
(see `require`).
...
indexed by the key `LUA_PRELOAD_TABLE`, a string."}}
                    :searchers {:binding "package.searchers"
                                :metadata {:fls/itemKind "Variable"
                                           :fnl/docstring "A table used by `require` to control how to find modules.
...
(This error message lists all file names it tried to open.)"}}}
           :metadata {:fls/itemKind "Module"
                      :fnl/docstring "The package library provides basic
...
The definition of what a lowercase letter is depends on the current locale."}}}
          :metadata {:fls/itemKind "Module"
                     :fnl/docstring "This library provides generic functions for string manipulation,
...
By default, `?i` is 1 and `?j` is `#list`."}}}
         :metadata {:fls/itemKind "Module"
                    :fnl/docstring "This library provides generic functions for table manipulation.
...
and returns a string with the concatenation of all these sequences."}}
                 :charpattern {:binding "utf8.charpattern"
                               :metadata {:fls/itemKind "Variable"
                                          :fnl/docstring "The pattern (a string, not a function) `\"[\\0-\\x7F\\xC2-\\xFD][\\x80-\\xBF]*\"`
which matches exactly one UTF-8 byte sequence,
assuming that the subject is a valid UTF-8 string."}}
                 :codepoint {:binding "utf8.codepoint"
                             :metadata {:fls/itemKind "Function"
                                        :fnl/arglist ["s" "?i" "?j" "?lax"]
...
This function assumes that `s` is a valid UTF-8 string."}}}
        :metadata {:fls/itemKind "Module"
                   :fnl/docstring "This library provides basic support for UTF-8 encoding.
